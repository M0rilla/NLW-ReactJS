          ...
          return (
            ...
            >
              ...
              <button
                ...
                /* Quando precisamos passar uma função que recebe um parâmetro a uma propriedade que espera
                receber uma função, é necessário utilizar arrow function, caso contrário estaríamos enviando
                a EXECUÇÃO de uma função ao onClick e não somente uma função.*/
              >
                {question.likeCount > 0 && <span>{question.likeCount}</span>}
                {/* && - Short circuit evaluation => if(true) && "run" () */}
               ...
               {/* inserimos diretamente o código do svg para que seja possível alterarmos a cor, import não permite isso. */}
              </button>
            </Question>            
          );
        })}
